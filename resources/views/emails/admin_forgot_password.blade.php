                                                                ...
                                                                <tr>
                                                                    <td>
                                                                       ...
                                                                       <p style="letter-spacing:1px;line-height:30px;text-align:left;">
                                                                        We received a request to reset your password. Please click on the button below to reset the password.
                                                    ...
                                                    <td>
                                                        <table width="100%" style="border-top:1px solid #ddd; margin-top:10px;border-radius:0 0 4px 4px;"> 
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <p style="line-height:30px;">Copyright &copy; <?php echo date('Y');?> BucketList. All rights reserved. </p>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
